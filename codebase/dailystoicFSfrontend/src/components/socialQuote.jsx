...
const SocialShare = () => {
    ...
    return (
        <div className="flex text-center flex-col lg:mt-20 mt-6 lg:w-6/12 w-12/12 mx-auto gap-6 justify-evenly">
            <p className="lg:text-4xl text-xl font-playfair">
                <span className="font-gothic">S</span>hare quote:
            </p>
            <div className="lg:text-2xl leading-tight text-xl font-playfair justify-center gap-6 lg:w-8/12 mx-auto mb-10 w-10/12">
